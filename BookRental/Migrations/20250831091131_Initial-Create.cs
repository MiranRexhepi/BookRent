        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    RentedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RentalLogs_RentalStatuses_RentalStatusId",
                        column: x => x.RentalStatusId,
                        principalTable: "RentalStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RentalLogs_Rentals_RentalId",
                        column: x => x.RentalId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RentalLogs_RentalId",
                table: "RentalLogs",
                column: "RentalId");

            migrationBuilder.CreateIndex(
                name: "IX_RentalLogs_RentalStatusId",
                table: "RentalLogs",
